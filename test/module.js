...
describe('module', () => {
  ...
  it('has all internal operation constants and functions', () => {
    ...
    assert.equal(internal.FETCH_FILTER_RESULT,'FETCH_FILTER_RESULT')
    assert.equal(internal.STORE_FILTER_RESULT,'STORE_FILTER_RESULT')
    ...
    assert(typeof internal.fetchFilterResult === 'function')
    assert(typeof internal.storeFilterResult === 'function')
  })
})
